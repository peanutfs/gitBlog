...
![Maven logo](../../resources/images/MavenLogo.png) 
...
>> ![下载页面](../../resources/images/MavenDownload.png)
> 2. 配置环境变量
...
>> 如果你完成了上述操作，打开cmd，输入：**mvn -v**，如果可以看到![版本信息](../../resources/images/mavenVersion.png)恭喜您！ Maven安装成功！
> 3. 了解Maven仓库
>> 
